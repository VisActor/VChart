...
export function IconDashedLine() {
  return (
...
export function IconThinDashedLine() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="41" height="28" viewBox="0 0 41 28" fill="none">
      <path d="M11.5 13H13.5V15H11.5V13Z" fill="#2B2F36" />
      <path d="M15.5 13H17.5V15H15.5V13Z" fill="#2B2F36" />
      <path d="M21.5 13H19.5V15H21.5V13Z" fill="#2B2F36" />
      <path d="M23.5 13H25.5V15H23.5V13Z" fill="#2B2F36" />
      <path d="M29.5 13H27.5V15H29.5V13Z" fill="#2B2F36" />
    </svg>
  );
}
