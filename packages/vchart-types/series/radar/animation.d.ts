...
export declare const radarGrowAnimation: (
...
export declare function radarPresetAnimation(
  params: IRadarAnimationParams,
...
export declare const radarSymbolMoveAnimation: (
  params: IRadarAnimationParams,
  animationType: 'in' | 'out'
) =>
  | {
...
export declare function radarSymbolPresetAnimation(
  params: IRadarAnimationParams,
  preset: RadarAppearPreset,
  animationType: 'in' | 'out'
):
...
export declare const radarGroupClipAnimation: (
  params: IRadarAnimationParams,
  animationType: 'in' | 'out'
