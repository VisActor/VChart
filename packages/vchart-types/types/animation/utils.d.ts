...
export declare function userAnimationConfig<M extends string, Preset extends string>(markName: SeriesMarkNameEnum | string, spec: IAnimationSpec<M, Preset>, ctx: IModelMarkAttributeContext): Partial<Record<"normal" | "state" | "appear" | "enter" | "exit" | "disappear" | "update" | "none", boolean | IAnimationConfig | IAnimationConfig[] | IStateAnimateSpec<Preset>>>;
...
export declare function uniformAnimationConfig<Preset extends string>(config: Partial<Record<IAnimationState, boolean | IStateAnimateSpec<Preset> | IAnimationConfig | IAnimationConfig[]>>, ctx: IModelMarkAttributeContext): Partial<Record<"normal" | "state" | "appear" | "enter" | "exit" | "disappear" | "update" | "none", boolean | IAnimationConfig | IAnimationConfig[] | IStateAnimateSpec<Preset>>>;
