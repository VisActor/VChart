...
export declare function userAnimationConfig<M extends string, Preset extends string>(markName: SeriesMarkNameEnum | string, spec: IAnimationSpec<M, Preset>): {
    appear: any;
    disappear: any;
    enter: any;
    exit: any;
...
export declare function shouldDoMorph(hasAnimation: boolean, morphConfig?: IMorphSeriesSpec, animationConfig?: ReturnType<typeof userAnimationConfig>): boolean;
