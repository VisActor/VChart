...
export interface IBarSeriesTheme extends ICartesianSeriesTheme, ThemeType<IBarSeriesSpec> {
...
export interface IBar3dSeriesTheme extends ICartesianSeriesTheme, ThemeType<IBar3dSeriesSpec> {
