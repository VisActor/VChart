...
export const STACK_FIELD_TOTAL_START = `${PREFIX}_STACK_TOTAL_START`;
export const STACK_FIELD_TOTAL_END = `${PREFIX}_STACK_TOTAL_END`;
export const STACK_FIELD_TOTAL_KEY = `${PREFIX}_STACK_TOTAL_KEY`;
export const STACK_FIELD_TOTAL_START_PERCENT = `${PREFIX}_STACK_TOTAL_START_PERCENT`;
export const STACK_FIELD_TOTAL_END_PERCENT = `${PREFIX}_STACK_TOTAL_END_PERCENT`;
