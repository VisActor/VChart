          ...
          if (newCacheInfo.labels[axisOrient]) {
            ...
            if (axisOrient === 'left') {
              ...
              newCacheInfo.labelsTextStyle[axisOrient] = {
                textAlign: syncAxisLabelAngle ? axisLabel.attribute.textAlign ?? 'right' : 'right',
                textBaseline: syncAxisLabelAngle ? axisLabel.attribute.textBaseline ?? 'middle' : 'middle'
              };
            } else if (axisOrient === 'right') {
              newCacheInfo.labels[axisOrient].dx = labelOffset;
              newCacheInfo.labelsTextStyle[axisOrient] = {
                textAlign: syncAxisLabelAngle ? axisLabel.attribute.textAlign ?? 'left' : 'left',
                textBaseline: syncAxisLabelAngle ? axisLabel.attribute.textBaseline ?? 'middle' : 'middle'
              };
              ...
              newCacheInfo.labelsTextStyle[axisOrient] = {
                textAlign: syncAxisLabelAngle ? axisLabel.attribute.textAlign ?? 'center' : 'center',
                textBaseline: syncAxisLabelAngle ? axisLabel.attribute.textBaseline ?? 'bottom' : 'bottom'
              };
            } else if (axisOrient === 'bottom') {
              newCacheInfo.labels[axisOrient].dy = labelOffset;
              newCacheInfo.labelsTextStyle[axisOrient] = {
                textAlign: syncAxisLabelAngle ? axisLabel.attribute.textAlign ?? 'center' : 'center',
                textBaseline: syncAxisLabelAngle ? axisLabel.attribute.textBaseline ?? 'top' : 'top'
              };
            }
