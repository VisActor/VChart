...
export class Layout implements IBaseLayout {
  private _leftCurrent: number = 0;
  private _topCurrent: number = 0;
  private _rightCurrent: number = 0;
  private _bottomCurrent: number = 0;
  ...
  private layoutNormalItems(normalItems: ILayoutItem[]): void {
   ...
   *
   */
  private layoutRegionItems(regionItems: IRegion[], regionRelativeItems: ILayoutItem[]): void {
   ...
   * @param item
   */
  private getItemComputeLayoutRect(item: ILayoutItem) {
    const result = {
  ...
  private _checkAutoIndent(items: ILayoutItem[]): IPadding {
    const result = {
      top: 0,
      left: 0,
      bottom: 0,
