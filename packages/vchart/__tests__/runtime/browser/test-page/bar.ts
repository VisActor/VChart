...
const run = () => {
  ...
  const spec = {
    ...
    data: [
      {
        values: [
          { x: 936196, size: 83431, y: 13, type: '技术', area: '东北' },
          { x: 1270911, size: 219815, y: 55, type: '办公用品', area: '中南' },
          { x: 453898, size: 19061, y: 72, type: '技术', area: '西南' },
          { x: 919743, size: 148800, y: 11, type: '家具', area: '华北' },
          { x: 1676224, size: 163453, y: 25, type: '家具', area: '华东' },
          { x: 1466575, size: 251487, y: 20, type: '技术', area: '中南' }
