/*
 * This data adapted from ECharts example: https://echarts.apache.org/examples/en/editor.html?c=treemap-disk
 * License: Apache-2.0(License: https://github.com/apache/echarts/blob/master/LICENSE)
 */
export const disk = [
  {
    value: 40,
...
].sort((nodeA, nodeB) => nodeB.value - nodeA.value);
