...
import type { IRole } from '../runtime-interface';
...
export interface IDataTempTransformConstructor {
  new ({ specProcess, role }: { role: IRoleVisactor; specProcess: ISpecProcess }): IDataTempTransform;
}
...
// 编辑元素
export interface IRoleVisactor extends IRole {
  // 清除编辑数据
