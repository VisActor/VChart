...
Axes support animations, but they are turned off by default. If you need to enable them, you need to enable the `animation` property on the specified axis in the `axes` property.
