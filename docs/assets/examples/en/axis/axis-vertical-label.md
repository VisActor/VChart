...
category: demo
group: axis
title: Axis label with vertical direction
...
# Axis label with vertical direction

By configuring `direction: 'vertical'` for `label.style`, we can achieve vertical display of axis labels

## Key Configuration

Configure the style for the axis label in the corresponding direction: `label: { style: { direction: 'vertical' } }`
