...
order: 9-4
cover: http://tosv.byted.org/obj/bit-cloud/vchart/preview/scatter-chart/stack-scatter.png
option: scatterChart
---
...
Attached are links to tutorials or API documentation related to the demo configuration.