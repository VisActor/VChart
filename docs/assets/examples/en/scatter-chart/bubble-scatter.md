...
Bubble scatter charts are a variant of basic scatter charts, which add an extra dimension to the base scatter chart by adjusting the size of data points to represent the value of a third variable. Typically, bubble scatter charts are used to show the relationship between three variables.
