...
category: demo
group: legend
title: Multiple Legends/Mixed Legends
keywords: scatterChart,comparison,distribution,scatter,legend
order: 27-3
cover: http://tosv.byted.org/obj/bit-cloud/vchart/preview/legend/multiple-legends.png
option: scatterChart#legends
---

# Multiple Legends/Mixed Legends
...
Here are links to tutorials or API documentation related to this demo configuration.