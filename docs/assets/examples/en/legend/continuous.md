...
order: 27-4
cover: http://tosv.byted.org/obj/bit-cloud/vchart/preview/legend/continuous.png
option: scatterChart#legends
---

# Continuous Legend

Continuous legend is used to represent continuous data, such as color, size, etc.
