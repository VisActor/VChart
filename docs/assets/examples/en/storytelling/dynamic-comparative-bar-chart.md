...
category: examples
group: storytelling
title: Dynamic Comparative Bar Chart
keywords: barChart,comparison,animation,player
order: 36-0
cover: https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/vchart/preview/storytelling/dynamic-comparative-bar-chart.gif
option: commonChart
---
...
- Grid layout, configured through the `layout` property, used for the layout of the bar chart.
- Using `type: common` type, that is, a combination chart.
