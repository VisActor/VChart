...
- The `customMark` attribute configures custom text marks
- The `animationUpdate` attribute configures the element update animation (growth animation duration > position swap animation duration)
