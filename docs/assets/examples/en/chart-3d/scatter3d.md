...
keywords: space
order: 23-5
cover: http://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/vchart/preview/chart-3d/scatter3d.png
option: scatterChart
---

# 3D Scatter Chart

Based on the 2D scatter chart, configure the zField to be recognized as a 3D scatter chart, and then configure the z axis.
