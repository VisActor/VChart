    ...
    mark: {
      title: {
        value: data => {
          ...
          // In the treemap, the datum field is an array used to store all data from the root node to the current node
          // Configure the tooltip title here to display the path of the current node
