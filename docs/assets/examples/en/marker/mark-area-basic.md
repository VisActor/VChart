...
# markArea Highlights Data Fluctuation in a Range

When we need to highlight the data fluctuation within a range, we can use the `markArea` data annotation component.
