...
# markLine in polar coordinates

## Key Configuration

- Use the `markLine.angle` property to declare the data values ​​on the angle axis
- Use the `markLine.radius` property to declare data values ​​or aggregate values ​​on the radius axis
- Use the `markLine.radius1` property to declare data values ​​or aggregate values ​​on the radius axis
