...
# markPoint in polar coordinates

## Key Configuration

- Use the `markPoint.angle` property to declare the data value on the angle axis
- Use the `markPoint.radius` property to declare the data values ​​on the radius axis
