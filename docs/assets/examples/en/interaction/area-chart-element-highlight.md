...
# Area Chart Element Highlight

By configuring the `element-highlight` interaction type, selected elements are highlighted, while other series elements are in a blurred state.
