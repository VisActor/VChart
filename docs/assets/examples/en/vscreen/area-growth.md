...
category: examples
group: vscreen
title: Area with Growth
keywords: areaChart,comparison,trend,area,animation
cover: /vchart/preview/area-growth.gif
option: vscreen
---
...
- Growth: point primitives and area primitives, growing upward
...
2. Normal animation: Carousel animation every interval.
   Normal animations for area charts include:

- Growth: point primitives and area primitives, growing upward
- Loading: The graphic element is viewed as a whole and expanded to the right
- Streamer: The streamer primitive moves from the starting point to the end point of the area primitive.

This case includes:
Admission: Growth + Normality: Growth and Streaming
