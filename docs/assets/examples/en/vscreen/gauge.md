...
Gauge chart in large screen scenario

## Key option

- The `categoryField` and `valueField` attributes are used to specify the data category and pointer angle field respectively.
- The `innerRadius` and `outerRadius` properties are used to specify the inner and outer radius of the dashboard
- The `startAngle` and `endAngle` properties are used to specify the start and end angles of the dashboard
- The `track` attribute can configure the background of the gauge series
