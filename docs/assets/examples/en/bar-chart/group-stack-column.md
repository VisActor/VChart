...
order: 2-2
cover: https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/vchart/preview/bar-chart/group-stack-column.png
option: barChart
---

# Grouped Stacked Column Chart

When multi-dimensional comparison is needed on a bar chart, a grouped stacked column chart can be used.

## Key Configuration

- Set the mapping field of the x-axis and the **grouping field** on the `xField` attribute.
- The `seriesField` attribute declares the color mapping field.
