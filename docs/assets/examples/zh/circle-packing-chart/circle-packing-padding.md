...
order: 20-2
cover: http://tosv.byted.org/obj/bit-cloud/vchart/preview/circle-packing-chart/circle-packing-padding.png
option: circlePackingChart
---

# 带内边距的 CirclePacking 图

可以通过 `layoutPadding` 配置每一层的内边距。

## 关键配置

- `layoutPadding` 每一层的内边距.
