...
title: 基础散点图
order: 9-0
cover: http://tosv.byted.org/obj/bit-cloud/vchart/preview/scatter-chart/basic-scatter.png
optio: scatterChart
---

# 基础散点图

基础散点图是一种用于显示两个变量之间关系的图表。它通常由两个轴组成，每个轴各代表一个变量。每个数据点在图表中表示为一个点，其位置由两个变量的值决定。

本示例中, 展示了 MilesPerGallon 和 Horsepower 之间的反比例关系.
