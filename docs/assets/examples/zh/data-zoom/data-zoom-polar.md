...
order: 29-4
cover: http://tosv.byted.org/obj/bit-cloud/vchart/preview/data-zoom/data-zoom-polar.png
option: radarChart#dataZoom
---

# 缩略轴控制极坐标系图表

通常来说, 缩略轴组件跟随笛卡尔坐标轴进行轴的缩放以更新图元. 而在 VChart 中, 缩略轴组件进行关联数据筛选从而触发轴的更新, 以此达到控制任意坐标轴的效果.
