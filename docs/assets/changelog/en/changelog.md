...
[more detail about v1.8.3-alpha.0](https://github.com/VisActor/VChart/releases/tag/v1.8.3-alpha.0)
...
**Full Changelog**: https://github.com/VisActor/VChart/compare/v1.6.7...v1.6.8

[more detail about v1.6.8](https://github.com/VisActor/VChart/releases/tag/v1.6.8)
...
**undefined**
- **@visactor/wx-vchart**:  fixed package delivery error issue, fixed [#1570](https://github.com/VisActor/VChart/issues/1570) , PR in [#1571](https://github.com/VisActor/VChart/issues/1571) 
