...
- **@visactor/vchart**: fix: ensure DataZoom updates when data source changes (Issue [#4185](https://github.com/VisActor/VChart/issues/4185))
...
[更多详情请查看 v2.0.18](https://github.com/VisActor/VChart/releases/tag/v2.0.18)
