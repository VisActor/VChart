...
- **@visactor/vchart**: remove the 词云图 shape afterRender tap when the series is released
- **@visactor/vchart**: bar smapling not work 问题. fix#4571
- **@visactor/vchart**: preserve 十字准星 visibility for explicitly bound multiple band axes （问题 #4127）
...
- **@visactor/vchart**: prevent rich text labels from inheriting line dash styles （问题 #4595）
- **@visactor/vchart**: unregister array-valued trigger event listeners on release
- **@visactor/vchart**: 修复 theme overwrite when change chartType in updateSpec
...
- **@visactor/vchart**: 修复 #4561 导致堆叠数值轴 十字准星 错误显示范围标签及偏移，保留马赛克和直方图的维度区间高亮
- **@visactor/vchart**: 修复 title width/height/minWidth/maxWidth/minHeight/maxHeight as ILayoutNumber against the chart view rect

**🔨 维护与杂项**

- **@visactor/vchart**: keep the 词云图 shape afterRender tap as a stable member callback

**Full Changelog**: https://github.com/VisActor/VChart/compare/v2.1.6...v2.1.7

[更多详情请查看 v2.1.7](https://github.com/VisActor/VChart/releases/tag/v2.1.7)
# v2.1.6
