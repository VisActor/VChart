...
Seemly to https://www.visactor.io/vchart/demo/combination/col-line，  In a combined chart, where there are usually multiple axes or multiple data areas, how should I configure the scrollbars so that they control the scrolling of the specified areas?
...
1. Bind the axis to the scroll bar:
...
2. Declare the layout position for the scroll bar:
