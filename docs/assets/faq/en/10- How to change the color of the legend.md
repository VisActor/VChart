---
title: 49. How to change the color of the VChart legend?</br>
key words: VisActor,VChart,VTable,VStrory,VMind,VGrammar,VRender,Visualization,Chart,Data,Table,Graph,Gis,LLM
---
## Title

How to change the color of the legend?</br>
## Description

Expect to control the color of the legend independently, not consistent with the graph.</br>
## Solution

Solutions of different chart libraries are different. </br>
Generally, the legends of VChart will remain consistent with the color of the main chart elements, providing users with color explanations. </br>
However, in some scenarios, it may be necessary to optimize the legend style separately, such as adding borders or increasing transparent colors. The legend configuration item of VChart supports separate control of the fill color.</br>
Method 1: Use `legends.data`, process the `shape` property of each legend in the callback function, thereby achieving the effect of modifying the legend style.</br>
Method 2: Use `legends.item.shape` to visibly control the style of each legend.</br>
## Code Example
