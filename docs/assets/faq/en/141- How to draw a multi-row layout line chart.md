---
title: 8. How to draw a line chart with a multi-line layout</br>
key words: VisActor,VChart,VTable,VStrory,VMind,VGrammar,VRender,Visualization,Chart,Data,Table,Graph,Gis,LLM
---
## Title

How to draw a line chart with a multi-line layout</br>


## Description

Can line charts achieve grouped line charts with the following multi-line layout?</br>
<img src='https://cdn.jsdelivr.net/gh/xuanhun/articles/visactor/img/KRDXbBobho97v1x0c8gc90nqnTd.gif' alt='' width='1280' height='557'>

## Solution

VChart can be combined with combo diagrams and grid layouts, refer to demo: https://visactor.io/vchart/demo/combination/col-line.</br>
## Code Example
