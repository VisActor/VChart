# How to use charts libraries in Vue, like VChart?

## Question Description

How to implement [a simple bar chart](https://www.visactor.io/vchart/demo/bar-chart/basic-column) using a chart library like VChart in Vue? Any tips for implementation?

![bar chart](/vchart/faq/30-0.png)

## Solution

In Vue 3.x, using VChart can be done in two ways:

1. Composition API, you can refer to[ the online demo](https://codesandbox.io/s/viscator-vchart-vue-demo-gmcpq6?file=/src/components/LineChart.vue) for details.
2. Options API, you can refer to [the online demo](https://codesandbox.io/s/viscator-vchart-vue-demo-gmcpq6?file=/src/components/BarChart.vue) for details. The encapsulation methods for different charts are similar.
...
- [Online demo](https://codesandbox.io/s/viscator-vchart-vue-demo-gmcpq6)
