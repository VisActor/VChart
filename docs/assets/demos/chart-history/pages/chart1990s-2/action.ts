...
export const pageChart1990s_2Action = (
  ...
  player.createAction(actorMap.pageChart1990s_2ActorTextZh, {
    pageList: [pageMap[pageKey].id],
  ...
  player.createAction(actorMap.pageChart1990s_2ActorTextEn, {
    pageList: [pageMap[pageKey].id],
    layer: layerMap.layerDom.id,
    transitionActs: [
      {
  ...
  player.createAction(actorMap.pageChart1990s_2ActorTitle, {
    pageList: [pageMap[pageKey].id],
    layer: layerMap.layerDom.id,
    transitionActs: [
      {
  ...
  player.createAction(actorMap.pageChart1990s_2ActorChart, {
    pageList: [pageMap[pageKey].id],
    ...
    acts: [
      {
        ...
        callback: async ({ avatar }) => {
          ...
          await wait(1000);
          avatar.vchart.updateData('data', getData().slice(0, 1));
          await wait(1000);
          anime({
            targets: avatar.dom,
            opacity: 0,
